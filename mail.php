...
<br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()">
	...
	<div id='footer'>
			<script type="text/javascript" src="https://cache1.value-domain.com/xa.j?site=edasan.s1008.xrea.com"></script>
	</div>
</body>
</html>
<?php }else{ ?>
